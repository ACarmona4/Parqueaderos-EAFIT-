...
public class InterfazDatos extends JPanel implements ActionListener {
    ...
    static JTextField mayor_textf;
    static JTextField menor_textf;
    ...
    public InterfazDatos() {
        ...
        diaMas_textf = new JTextField ("Más flujo: martes");
        mayor_textf = new JTextField ("Más transcurrida: ");
        menor_textf = new JTextField ("Menos transcurrida: ");
        diaMenos_textf = new JTextField ("Menos fujo: viernes");
        ...
        //-------------
        ArrayList<String> horas = Persistencia.leerFichero();
        ArrayList<String> dias = Persistencia.leerFichero2();
        String datoMas = Procesamiento.analizarDatosMayor(horas);
        String datoMenos = Procesamiento.analizarDatosMenor(horas);
        String diaMas = Procesamiento.analizarDiaMas(dias);
        String diaMenos = Procesamiento.analizarDiaMenos(dias);
        mayor_textf.setText("Más flujo a las: "+datoMas+" horas");
        menor_textf.setText("Menos flujo a las: "+datoMenos+" horas");
        diaMas_textf.setText("Día con mayor flujo: "+diaMas);
        diaMenos_textf.setText("Día con menos flujo: "+diaMenos);
